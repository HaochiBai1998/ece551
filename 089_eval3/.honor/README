...
"read" the story. In particular:
 ...
 5. After checking for any problems with the story, you should begin the
	...
	page, prompt the user ("That is not a valid choice, please try
	again") and read another number. Repeat until they give a valid
	choice.
...
For this assignment, we will provide a pregrader as well, be sure to pass
the pregrader test before the hard deadline.
 
Also, remember to git add, commit, push and grade your work before the 
hard deadline.
